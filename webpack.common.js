    ...
    new WorboxWebpackPlugin.GenerateSW({
      ...
      runtimeCaching: [
        ...
        },
        {
          ...
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'restaurants-image-api-large',
          },
        },
        {
          urlPattern: ({ url }) =>
          ...
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'restaurants-image-api-small',
          },
        },
        {
          urlPattern: ({ url }) =>
          ...
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'restaurants-detail-api',
          },
        },
        {
          urlPattern: ({ url }) =>
            url.href.startsWith(
              'https://fonts.googleapis.com/css2?family=Merienda:wght@400;800;900&display=swap'
            ),
          handler: 'StaleWhileRevalidate',
          options: {
            cacheName: 'font-family-merienda',
          },
        },
      ],
    }),
